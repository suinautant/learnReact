...
class InlineList extends PureComponent {
  render() {
    ...
    return (
      <div
        {...css(
          styles.wrapper, // withStyles의 wrapper 속성으로 가로 배치를 위한 속성
...
export default withStyles(() => ({
  wrapper: {
    display: 'flex', // withStyles의 wrapper 속성으로 가로 배치를 위한 속성
    flexDirection: 'row', // withStyles의 wrapper 속성으로 가로 배치를 위한 속성
    flexWrap: 'wrap',
